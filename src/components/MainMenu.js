...
const MainMenu = () => {
  ...
  return (
    <MainMenuArea>
      <MenuButton name={"Linktree"} target={"https://linktr.ee/twrpband"} title={"TWRP Linktree"} newTab={true}/>
      ...
      <MenuButton name={"Merch"} target={"https://store.twrpband.com/"} title={"Checkout TWRP merch"} newTab={true}/>
